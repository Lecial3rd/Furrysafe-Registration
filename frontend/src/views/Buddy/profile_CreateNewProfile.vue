...
const currentMode = route.query.mode || 'create'; // Default to 'create' if no mode is provided
...
<template>
    <div class="bg-white rounded-t-2xl">
        <div id="marginright" class="pb-[1rem] lg:mx-[3rem] flex justify-between items-center">
            <div class="mt-8">
                <RouterLink to="/buddy_profile" class="flex items-center">
            ...
            <div id="margin" class="space-y-12 sm:mx-[3rem] md:mx-[2rem] lg:mx-[10rem] my-[2.5rem]">
                <div class="border-b border-gray-900/10 pb-7">
                    <h2 class="text-base font-semibold leading-7 text-gray-900">
                        {{ currentMode === 'edit' ? 'Edit Animal Profile' : 'Create Animal Profile' }}</h2>
                ...
                <div class="flex items-center justify-end gap-x-6">
                    <RouterLink to="/buddy_profile" class="text-sm font-semibold leading-6 text-gray-900">
                        Cancel</RouterLink>
                    <button type="button" @click="handleSubmit"
                        ...
                        {{ currentMode === 'edit' ? 'Save Changes' : 'Create Profile' }}</button>
                </div>
            </div>
        </form>
